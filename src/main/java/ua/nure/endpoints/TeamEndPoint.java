...
public class TeamEndPoint {
    ...
    @PayloadRoot(namespace = NAMESPACE, localPart = UPDATE_REQUEST)
    @Oneway
    ...
    @PayloadRoot(namespace = NAMESPACE, localPart = DELETE_REQUEST)
    @Oneway
    ...
    @PayloadRoot(namespace = NAMESPACE, localPart = FIND_REQUEST)
    @ResponsePayload
    public JAXBElement<FindTeamResponse> findTeam(@RequestPayload JAXBElement<FindTeamRequest> request) {
        ...
        return new JAXBElement<>(QName.valueOf(FIND_RESPONSE), FindTeamResponse.class, response);
    }

    @PayloadRoot(namespace = NAMESPACE, localPart = GET_COUNT_REQUEST)
    @ResponsePayload
    public JAXBElement<GetPlayersCountResponse> getPlayersCount(@RequestPayload JAXBElement<GetPlayersCountRequest> request) {
        ...
        return new JAXBElement<>(QName.valueOf(GET_COUNT_RESPONSE), GetPlayersCountResponse.class, response);
    }
