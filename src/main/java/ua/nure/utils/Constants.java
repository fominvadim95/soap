...
public class Constants {
    ...
    public static final String WSDL_LOCATION = "/soapws";

    public static final String PORT_NAME = "Teams";

    public static final String NAMESPACE = "http://entities.nure.ua";

    public static final String SCHEMA = "teams.xsd";

    public static final String SERVLET_NAME = "dispatcher";

    public static final String URL_PATTERN = "/soapws/*";

    public static final String UPDATE_TEAM_REQUEST = "updateTeamRequest";

    public static final String DELETE_TEAM_REQUEST = "deleteTeamRequest";

    public static final String DELETE_PLAYER_REQUEST = "deletePlayerRequest";
