...
@XmlRootElement(name = "findPlayerRequest")
public class FindPlayerRequest implements ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "playerId", buffer, thePlayerId, (this.playerId!= null));
        }
        return buffer;
    }
