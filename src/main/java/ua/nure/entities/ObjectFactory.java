...
public class ObjectFactory {
    ...
    private final static QName _GetPlayersByCountryResponse_QNAME = new QName("http://entities.nure.ua", "getPlayersByCountryResponse");
    private final static QName _DeletePlayerRequest_QNAME = new QName("http://entities.nure.ua", "deletePlayerRequest");
    private final static QName _GetPlayersByCountryRequest_QNAME = new QName("http://entities.nure.ua", "getPlayersByCountryRequest");
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetPlayersByCountryResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://entities.nure.ua", name = "getPlayersByCountryResponse")
    public JAXBElement<GetPlayersByCountryResponse> createGetPlayersByCountryResponse(GetPlayersByCountryResponse value) {
        return new JAXBElement<GetPlayersByCountryResponse>(_GetPlayersByCountryResponse_QNAME, GetPlayersByCountryResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetPlayersByCountryRequest }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://entities.nure.ua", name = "getPlayersByCountryRequest")
    public JAXBElement<GetPlayersByCountryRequest> createGetPlayersByCountryRequest(GetPlayersByCountryRequest value) {
        return new JAXBElement<GetPlayersByCountryRequest>(_GetPlayersByCountryRequest_QNAME, GetPlayersByCountryRequest.class, null, value);
    }
